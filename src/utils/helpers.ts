...
export const calculateInventoryValue = (products: any[]): number => {
  return products.reduce((total, product) => total + (product.quantity * product.price), 0);
};

export const getLowStockProducts = (products: any[]): any[] => {
...
export const validateSKU = (sku: string, existingProducts: any[], currentProductId?: string): boolean => {
